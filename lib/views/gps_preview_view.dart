...
import 'package:airotrack_courier/views/camera_details_view.dart';
import 'package:airotrack_courier/views/device_preview_view.dart';
import 'package:airotrack_courier/views/gps_scan_device_view.dart';
import 'package:airotrack_courier/views/speed_governor_details_view.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Obx(() {
                    final total = homeController.newGpsCount.value + homeController.repairedGpsCount.value;
                    return Column(
                      children: [
                        _buildInfoRow("Total Devices", "$total"),
                        height15,
                        _buildInfoRow("New Devices", "${homeController.newGpsCount.value}"),
                        height15,
                        InkWell(
                          onTap: () => Get.to(() => const DevicePreviewView()),
                          child: _buildInfoRow("Repaired Devices", "${homeController.repairedGpsCount.value}"),
                        ),
                      ],
                    );
                  }),
